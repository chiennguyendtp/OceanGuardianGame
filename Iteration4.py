...
pygame.mixer.init()
#Music and Sounds
GameMusic = pygame.mixer.music.load("BackgroundMusic.wav")
...
class Player:
    def __init__(self, x, y):
        ...
        #load sprites image
        self.sprite = pygame.image.load("RobotFish.png")
    ...
    def draw(self):
        ...
        if self.state == "home":
            ...
            # draws the intro screen
                ...
                obj2 = font.render("a specified time, You need to get 10 rubbish to win.", True, WHITE)
